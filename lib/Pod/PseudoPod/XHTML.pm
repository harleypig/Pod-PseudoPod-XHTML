...
Pod::PseudoPod::XHTML - The great new Pod::PseudoPod::XHTML!
...
Perhaps a little code snippet.
    ...
    my $foo = Pod::PseudoPod::XHTML->new();
    ...
...
Please report any bugs or feature requests to C<bug-pod-pseudopod-xhtml at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Pod-PseudoPod-XHTML>.  I will be notified, and then you'll
